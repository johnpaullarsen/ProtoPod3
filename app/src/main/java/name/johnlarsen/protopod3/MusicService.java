...
import name.johnlarsen.protopod3.LoisPodActivity;
 ...
 * {@link LoisPodActivity}, which signal the service to perform specific operations: Play, Pause,
 * Rewind, Skip, etc.
 */
public class MusicService extends Service implements OnCompletionListener, OnPreparedListener,
    ...
    // AndroidManifest.xml.
    public static final String ACTION_TOGGLE_PLAYBACK = "name.johnlarsen.protopod3.action.TOGGLE_PLAYBACK";
    public static final String ACTION_PLAY = "name.johnlarsen.protopod3.action.PLAY";
    public static final String ACTION_PAUSE = "name.johnlarsen.protopod3.action.PAUSE";
    public static final String ACTION_STOP = "name.johnlarsen.protopod3.action.STOP";
    ...
    public void onCreate() {
        ...
        // JPL mDummyAlbumArt = BitmapFactory.decodeResource(getResources(), R.drawable.dummy_album_art);
    ...
    void updateNotification(String text) {
        PendingIntent pi = PendingIntent.getActivity(getApplicationContext(), 0,
                new Intent(getApplicationContext(), LoisPodActivity.class),
    ...
    void setUpAsForeground(String text) {
        ...
        // JPL mNotification.icon = R.drawable.ic_stat_playing;
